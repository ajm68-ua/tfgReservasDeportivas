    ...
    <div v-else-if="usuario" class="max-w-5xl mx-auto flex flex-col lg:flex-row gap-6">
      ...
      <div class="w-full lg:w-1/3 xl:w-1/4 flex flex-col gap-6">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center">
          ...
          <div class="w-full bg-yellow-50 border border-yellow-100 rounded-xl p-3 flex items-center justify-center gap-2 mb-6 shadow-sm">
            ...
            <div class="text-sm">
              <span class="font-bold text-gray-800">{{ resenas.length > 0 ? (resenas.reduce((acc, r) => acc + r.puntuacion, 0) / resenas.length).toFixed(1) : '0.0' }}/5</span>
